// CNCFMp3Tag.h : Declaration of the CNCFMp3Tag
...
class ATL_NO_VTABLE CNCFMp3Tag :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CNCFMp3Tag, &CLSID_NCFMp3Tag>,
	public ISupportErrorInfo,
	public IDispatchImpl<INCFMp3Tag, &IID_INCFMp3Tag, &LIBID_ItSoftwareNCFAudioLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{	
...
DECLARE_REGISTRY_RESOURCEID(IDR_CNCFMP3TAG)

DECLARE_NOT_AGGREGATABLE(CNCFMp3Tag)

BEGIN_COM_MAP(CNCFMp3Tag)
	COM_INTERFACE_ENTRY( INCFAudioTag )
	COM_INTERFACE_ENTRY(INCFMp3Tag)
...
OBJECT_ENTRY_AUTO(__uuidof(NCFMp3Tag), CNCFMp3Tag)
