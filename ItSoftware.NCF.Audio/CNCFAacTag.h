// CNCFAacTag.h : Declaration of the CNCFAacTag
...
class ATL_NO_VTABLE CNCFAacTag :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CNCFAacTag, &CLSID_NCFAacTag>,
	public ISupportErrorInfo,
	public IDispatchImpl<INCFAacTag, &IID_INCFAacTag, &LIBID_ItSoftwareNCFAudioLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
...
DECLARE_REGISTRY_RESOURCEID(IDR_CNCFAACTAG)


BEGIN_COM_MAP(CNCFAacTag)
	COM_INTERFACE_ENTRY( INCFAudioTag )
	COM_INTERFACE_ENTRY(INCFAacTag)
...
OBJECT_ENTRY_AUTO(__uuidof(NCFAacTag), CNCFAacTag)
