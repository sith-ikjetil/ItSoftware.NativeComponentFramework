// CWMHeaderInfo.cpp : Implementation of CWMHeaderInfo

#include "stdafx.h"
#include "wmsdkidl.h"
#include "CNCFWmaTag.h"
#include "../ItSoftware.NCF.System/ItSoftwareNCFSystem_i.h"
#include "../ItSoftware.NCF.Audio/ItSoftwareNCFAudio_i.h"

// CWMHeaderInfo

STDMETHODIMP CNCFWmaTag::InterfaceSupportsErrorInfo(REFIID riid)
{
...
// INCFWMHeaderInfo
//
STDMETHODIMP CNCFWmaTag::SetTitle( /*[in]*/ BSTR title)
{
	m_bstrTitle.Empty();
...
STDMETHODIMP CNCFWmaTag::GetTitle( /*[out, retval]*/ BSTR *title)
{
	if (title == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetAuthor( /*[in]*/ BSTR author)
{
	m_bstrAuthor.Empty();
...
STDMETHODIMP CNCFWmaTag::GetAuthor( /*[out, retval]*/ BSTR *author)
{
	if (author == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetDescription( /*[in]*/ BSTR description)
{
...
STDMETHODIMP CNCFWmaTag::GetDescription( /*[out, retval]*/ BSTR *description)
{
	if (description == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetRating( /*[in]*/ BSTR rating)
{
	m_bstrRating.Empty();
...
STDMETHODIMP CNCFWmaTag::GetRating( /*[out, retval]*/ BSTR *rating)
{
	if (rating == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetCopyright( /*[in]*/ BSTR copyright)
{
...
STDMETHODIMP CNCFWmaTag::GetCopyright( /*[out, retval]*/ BSTR *copyright)
{
	if (copyright == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetAlbumTitle( /*[in]*/ BSTR album)
{
...
STDMETHODIMP CNCFWmaTag::GetAlbumTitle( /*[out, retval]*/ BSTR *album)
{
	if (album == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetTrack(/*[in]*/ BSTR track_number)
{
	m_bstrTrack.Empty();
...
STDMETHODIMP CNCFWmaTag::GetTrack(/*[out, retval]*/ BSTR *track_number)
{
...
STDMETHODIMP CNCFWmaTag::SetGenre( /*[in]*/ BSTR genre)
{
	m_bstrGenre.Empty();
...
STDMETHODIMP CNCFWmaTag::GetGenre( /*[out, retval]*/ BSTR *genre)
{
	if (genre == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetYear( /*[in]*/ BSTR year)
{
	m_bstrYear.Empty();
...
STDMETHODIMP CNCFWmaTag::GetYear( /*[out, retval]*/ BSTR *year)
{
	if (year == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetCopyrightURL( /*[in]*/ BSTR copyright_url)
{
...
STDMETHODIMP CNCFWmaTag::GetCopyrightURL( /*[out, retval]*/ BSTR *copyright_url)
{
...
STDMETHODIMP CNCFWmaTag::GetComposer( /*[out, retval]*/ BSTR *composer)
{
	if (composer == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetComposer( /*[in]*/ BSTR composer)
{
...
STDMETHODIMP CNCFWmaTag::SetAlbumCoverURL( /*[in]*/ BSTR album_cover_url)
{
...
STDMETHODIMP CNCFWmaTag::GetAlbumCoverURL( /*[out, retval]*/ BSTR *album_cover_url)
{
	if (album_cover_url == NULL) {
		return Error(CComBSTR(L"GetLyrics Failed. Invalid Arguments."), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetPromotionURL( /*[in]*/ BSTR promotion_url)
{
...
STDMETHODIMP CNCFWmaTag::GetPromotionURL( /*[out, retval]*/ BSTR *promotion_url)
{
...
STDMETHODIMP CNCFWmaTag::SetLyrics( /*[in]*/ BSTR lyrics)
{
	m_bstrLyrics.Empty();
...
STDMETHODIMP CNCFWmaTag::GetLyrics( /*[out, retval]*/ BSTR *lyrics)
{
	if (lyrics == NULL) {
		return Error(CComBSTR(L"GetLyrics Failed. Invalid Arguments."), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::LoadFromFile( /*[in]*/ BSTR filename)
{
	...
	if (FAILED(hr)) {
		return Error(CComBSTR(L"LoadFromFile Failed. WMCreateEditor Failed."), IID_INCFWmaTag, E_INVALIDARG);
	}

	hr = pIWMMetadataEditor->Open(filename);
	if (FAILED(hr)) {
		return Error(CComBSTR(L"LoadFromFile Failed. Failed To Open File."), IID_INCFWmaTag, E_INVALIDARG);
	}

	CComQIPtr<IWMHeaderInfo3> pIWMHeaderInfo3;
	pIWMHeaderInfo3 = pIWMMetadataEditor;
	if (pIWMHeaderInfo3.p == NULL) {
		return Error(CComBSTR(L"LoadFromFile Failed. Failed To QueryInterface for IWMHeaderInfo interface on IWMMetadataEditor."), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SetAlbumAuthor(/*[in]*/ BSTR author)
{
	this->m_bstrAlbumAuthor = author;
	return S_OK;
}

STDMETHODIMP CNCFWmaTag::GetAlbumAuthor(/*[out,retval]*/ BSTR *author)
{
	if (author == nullptr) {
		return Error(CComBSTR(L"GetAlbumAuthor failed. Invalid Arguments."), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::SaveToFile( /*[in]*/ BSTR filename)
{
	if (SysStringLen(filename) == 0) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
	...
	hr = WMCreateEditor(&pIWMMetadataEditor);
	if (FAILED(hr)) {
		return Error(CComBSTR(L"SaveToFile Failed. WMCreateEditor Failed."), IID_INCFWmaTag, E_INVALIDARG);
	}

	hr = pIWMMetadataEditor->Open(filename);
	if (FAILED(hr)) {
		return Error(CComBSTR(L"SaveToFile Failed. Failed To Open File."), IID_INCFWmaTag, E_INVALIDARG);
	}

	CComQIPtr<IWMHeaderInfo3> pIWMHeaderInfo3;
	pIWMHeaderInfo3 = pIWMMetadataEditor;
	if (pIWMHeaderInfo3.p == NULL) {
		return Error(CComBSTR(L"SaveToFile Failed. Failed To QueryInterface for IWMHeaderInfo interface on IWMMetadataEditor."), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::LoadFromInterface( /*[in]*/ IUnknown *pIUnknown)
{
	CComQIPtr<IWMHeaderInfo3> pIWMHeaderInfo3;
...
STDMETHODIMP CNCFWmaTag::SaveToInterface( /*[in]*/ IUnknown *pIUnknown)
{
	if (pIUnknown == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::get_Duration( /*[out, retval]*/ long *milliseconds)
{
	if (milliseconds == NULL) {
		return Error(CComBSTR(L"milliseconds is NULL"), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::get_HasAudio( /*[out, retval]*/ VARIANT_BOOL *has_audio)
{
	if (has_audio == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFWmaTag::get_HasVideo( /*[out, retval]*/ VARIANT_BOOL *has_video)
{
	if (has_video == NULL) {
		return Error(CComBSTR(L""), IID_INCFWmaTag, E_INVALIDARG);
	}
...
CComBSTR CNCFWmaTag::GetStringAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
DWORD CNCFWmaTag::GetDWORDAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
QWORD CNCFWmaTag::GetQWORDAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
BOOL CNCFWmaTag::GetBOOLAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
void CNCFWmaTag::SetStringAttribute(const wchar_t *name, BSTR value, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
	WMT_ATTR_DATATYPE wad = WMT_TYPE_STRING;
...
void CNCFWmaTag::SetDWORDAttribute(const wchar_t *name, DWORD value, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
