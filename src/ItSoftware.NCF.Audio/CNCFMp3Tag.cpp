// CNCFMp3Tag.cpp : Implementation of CNCFMp3Tag

#include "stdafx.h"
#include "CNCFMp3Tag.h"
#include "wmsdkidl.h"
...
STDMETHODIMP CNCFMp3Tag::InterfaceSupportsErrorInfo(REFIID riid)
{
...
// INCFWMHeaderInfo
//
STDMETHODIMP CNCFMp3Tag::SetTitle( /*[in]*/ BSTR title)
{
	m_bstrTitle.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetTitle( /*[out, retval]*/ BSTR *title)
{
	if (title == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetAuthor( /*[in]*/ BSTR author)
{
	m_bstrAuthor.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetAuthor( /*[out, retval]*/ BSTR *author)
{
	if (author == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetDescription( /*[in]*/ BSTR description)
{
...
STDMETHODIMP CNCFMp3Tag::GetDescription( /*[out, retval]*/ BSTR *description)
{
	if (description == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetRating( /*[in]*/ BSTR rating)
{
	m_bstrRating.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetRating( /*[out, retval]*/ BSTR *rating)
{
	if (rating == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetCopyright( /*[in]*/ BSTR copyright)
{
...
STDMETHODIMP CNCFMp3Tag::GetCopyright( /*[out, retval]*/ BSTR *copyright)
{
	if (copyright == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetAlbumTitle( /*[in]*/ BSTR album)
{
...
STDMETHODIMP CNCFMp3Tag::GetAlbumTitle( /*[out, retval]*/ BSTR *album)
{
	if (album == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetTrack(/*[in]*/ BSTR track_number)
{
	m_bstrTrack.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetTrack(/*[out, retval]*/ BSTR *track_number)
{
...
STDMETHODIMP CNCFMp3Tag::SetGenre( /*[in]*/ BSTR genre)
{
	m_bstrGenre.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetGenre( /*[out, retval]*/ BSTR *genre)
{
	if (genre == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetYear( /*[in]*/ BSTR year)
{
	m_bstrYear.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetYear( /*[out, retval]*/ BSTR *year)
{
	if (year == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetCopyrightURL( /*[in]*/ BSTR copyright_url)
{
...
STDMETHODIMP CNCFMp3Tag::GetCopyrightURL( /*[out, retval]*/ BSTR *copyright_url)
{
...
STDMETHODIMP CNCFMp3Tag::GetComposer( /*[out, retval]*/ BSTR *composer)
{
	if (composer == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetComposer( /*[in]*/ BSTR composer)
{
...
STDMETHODIMP CNCFMp3Tag::SetAlbumCoverURL( /*[in]*/ BSTR album_cover_url)
{
...
STDMETHODIMP CNCFMp3Tag::GetAlbumCoverURL( /*[out, retval]*/ BSTR *album_cover_url)
{
	if (album_cover_url == NULL) {
		return Error(CComBSTR(L"GetAlbumCoverURL failed. Invalid Arguments."), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetPromotionURL( /*[in]*/ BSTR promotion_url)
{
...
STDMETHODIMP CNCFMp3Tag::GetPromotionURL( /*[out, retval]*/ BSTR *promotion_url)
{
	if (promotion_url == NULL) {
		return Error(CComBSTR(L"GetPromotionURL failed. Invalid Arguments."), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetLyrics( /*[in]*/ BSTR lyrics)
{
	m_bstrLyrics.Empty();
...
STDMETHODIMP CNCFMp3Tag::GetLyrics( /*[out, retval]*/ BSTR *lyrics)
{
	if (lyrics == NULL) {
		return Error(CComBSTR(L"GetLyrics Failed. Invalid Arguments."), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SetAlbumAuthor(/*[in]*/ BSTR author)
{
	this->m_bstrAlbumAuthor = author;
	return S_OK;
}

STDMETHODIMP CNCFMp3Tag::GetAlbumAuthor(/*[out,retval]*/ BSTR *author)
{
	if (author == nullptr) {
		return Error(CComBSTR(L"GetAlbumAuthor failed. Invalid Arguments."), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::LoadFromFile( /*[in]*/ BSTR filename)
{
	...
	if (FAILED(hr)) {
		return Error(CComBSTR(L"LoadFromFile Failed. WMCreateEditor Failed."), IID_INCFMp3Tag, E_INVALIDARG);
	}

	hr = pIWMMetadataEditor->Open(filename);
	if (FAILED(hr)) {
		return Error(CComBSTR(L"LoadFromFile Failed. Failed To Open File."), IID_INCFMp3Tag, E_INVALIDARG);
	}

	CComQIPtr<IWMHeaderInfo3> pIWMHeaderInfo3;
	pIWMHeaderInfo3 = pIWMMetadataEditor;
	if (pIWMHeaderInfo3.p == NULL) {
		return Error(CComBSTR(L"LoadFromFile Failed. Failed To QueryInterface for IWMHeaderInfo interface on IWMMetadataEditor."), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::SaveToFile( /*[in]*/ BSTR filename)
{
	if (SysStringLen(filename) == 0) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
	...
	hr = WMCreateEditor(&pIWMMetadataEditor);
	if (FAILED(hr)) {
		return Error(CComBSTR(L"SaveToFile Failed. WMCreateEditor Failed."), IID_INCFMp3Tag, E_INVALIDARG);
	}

	hr = pIWMMetadataEditor->Open(filename);
	if (FAILED(hr)) {
		return Error(CComBSTR(L"SaveToFile Failed. Failed To Open File."), IID_INCFMp3Tag, E_INVALIDARG);
	}

	CComQIPtr<IWMHeaderInfo3> pIWMHeaderInfo3;
	pIWMHeaderInfo3 = pIWMMetadataEditor;
	if (pIWMHeaderInfo3.p == NULL) {
		return Error(CComBSTR(L"SaveToFile Failed. Failed To QueryInterface for IWMHeaderInfo interface on IWMMetadataEditor."), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::LoadFromInterface( /*[in]*/ IUnknown *pIUnknown)
{
	CComQIPtr<IWMHeaderInfo3> pIWMHeaderInfo3;
...
STDMETHODIMP CNCFMp3Tag::SaveToInterface( /*[in]*/ IUnknown *pIUnknown)
{
	if (pIUnknown == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::get_Duration( /*[out, retval]*/ long *milliseconds)
{
	if (milliseconds == NULL) {
		return Error(CComBSTR(L"milliseconds is NULL"), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::get_HasAudio( /*[out, retval]*/ VARIANT_BOOL *has_audio)
{
	if (has_audio == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
STDMETHODIMP CNCFMp3Tag::get_HasVideo( /*[out, retval]*/ VARIANT_BOOL *has_video)
{
	if (has_video == NULL) {
		return Error(CComBSTR(L""), IID_INCFMp3Tag, E_INVALIDARG);
	}
...
CComBSTR CNCFMp3Tag::GetStringAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
DWORD CNCFMp3Tag::GetDWORDAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
QWORD CNCFMp3Tag::GetQWORDAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
BOOL CNCFMp3Tag::GetBOOLAttribute(const wchar_t *name, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
...
void CNCFMp3Tag::SetStringAttribute(const wchar_t *name, BSTR value, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
	WMT_ATTR_DATATYPE wad = WMT_TYPE_STRING;
...
void CNCFMp3Tag::SetDWORDAttribute(const wchar_t *name, DWORD value, IWMHeaderInfo3 *pIWMHeaderInfo)
{
	HRESULT hr(S_OK);
